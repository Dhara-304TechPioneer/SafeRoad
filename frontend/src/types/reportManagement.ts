...
export interface ManagedReport { id: string; date: string; location: string; description: string; roadType: string; severity: Severity; traffic: string; status: ReportStatus; aiVerified: boolean; priority: string; imageLabel: string; }
